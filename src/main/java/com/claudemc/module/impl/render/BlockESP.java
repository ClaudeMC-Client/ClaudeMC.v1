...
/**
 * Highlights specified blocks through walls.
 * Targets: shulker boxes, chests, spawners, and any user-added IDs.
 */
public class BlockESP extends Module {

    public static BlockESP INSTANCE;

    // Block IDs to highlight – user editable via setSetting("Blocks")
    ...
    public BlockESP() {
        ...
        addSetting("Shulkers",   "true");
        addSetting("Chests",     "true");
        addSetting("Spawners",   "true");
        addSetting("Custom",     "");  // comma-separated extra block IDs
        INSTANCE = this;
        ...
        WorldRenderEvents.AFTER_ENTITIES.register(context -> {
            ...
            for (int x = playerPos.getX() - radius; x <= playerPos.getX() + radius; x += 1) {
